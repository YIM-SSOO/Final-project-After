...
<body id="page-top">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                전체 회원수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">45,000명</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                방문자 수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">2,300명</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="far fa-id-card fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                전체 홈짐 수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">137개</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                신규 홈짐 수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">13개</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dumbbell fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                신규 알림 수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">21개</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-comments fa-2x text-gray-300"></i>
                                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">회원 수 추이</h6>
    ...
    <!-- Page level plugins -->
    <script src="../../../resources/ad_assets/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../../../resources/ad_assets/js/demo/chart-area-demo.js"></script>
    <script src="../../../resources/ad_assets/js/demo/chart-pie-demo.js"></script>
    <script src="../../../resources/ad_assets/js/demo/chart-bar-demo.js"></script>
