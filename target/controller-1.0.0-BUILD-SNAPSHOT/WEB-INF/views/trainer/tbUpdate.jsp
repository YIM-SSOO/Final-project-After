						...
						<!-- <form class="form" method="post" action="tbList.do"> -->
							<div class="row">
								...
								<div class="col-lg-6 col-12">
									...
									<div>
										<input type="file" name="tbImg" id="tbImage"accept="image/*" style="margin-bottom: 30px;">
									<!-- 	<div id="image_container"></div> -->
										<img src="/resources/imgUpload/${trainerBoard.tbImg}"/>
										<input type="button" id="tbImgDelete" value="이미지 삭제"/>
								...
								<!-- 	<div class="form-group button" style="text-align: center;">
										<button type="submit" class="btn"style="background-color: #3428A5; width: 110px;">수정</button>
									</div>
								</div>
								<div style="margin-top: 20px; text-align: center;"> -->
							<div class="button" style="text-align:center;">
                                <a href="#" class="btn" style="margin-top:5px; border-radius:5px;" > 수정 완료 </a>
